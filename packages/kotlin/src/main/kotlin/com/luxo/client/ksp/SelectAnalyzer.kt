...
object SelectAnalyzer {
    ...
    private fun generateHints(hints: Map<String, FieldNode>, packageName: String): String = buildString {
        ...
        for ((api, node) in hints) {
            ...
            val depth = node.maxDepth()
            if (depth > MAX_NESTING_DEPTH) {
                println("[luxo] Warning: $api has $depth-level nested field selection (max recommended: $MAX_NESTING_DEPTH). Consider restructuring your query.")
            }
