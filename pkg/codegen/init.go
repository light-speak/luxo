...
// Creates the module schema and resolver. The luxis/<module> entry point is
// generated by `luxo gen` (main.gen.go) — a hand-written main.go in the same
// directory would collide with it (duplicate package main / func main).
